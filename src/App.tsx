  ...
  const handleAuthSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.code === 'auth/wrong-password' || err.code === 'auth/user-not-found' || err.code === 'auth/invalid-credential') {
        ...
        setAuthError('Email/Password authentication is not enabled. Please enable it in the Firebase Console.');
      } else {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (err.code === 'auth/operation-not-allowed') {
        ...
        setAuthError('An account already exists with this email address using a different sign-in method.');
      } else if (err.code === 'auth/invalid-credential') {
        setAuthError('The credentials provided are invalid or expired.');
      } else {
