...
export default function CoachingSidebar({
  ...
  const menuItems = [
    ...
    { id: 'homeworks', label: 'Homework', icon: FileText },
      ...
      <div className="p-4 border-b border-slate-800 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <span className="text-[10px] text-orange-400 font-mono tracking-wider font-extrabold uppercase">COACHING SUITE</span>
          </div>
        </div>
