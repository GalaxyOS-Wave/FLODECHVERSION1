...
export default function DanceSidebar({
  activeTab,
  setActiveTab,
  isMobileMenuOpen,
  setIsMobileMenuOpen,
  ...
  const menuItems = [
    ...
    { id: 'students', label: 'Dancers', icon: Users },
    { id: 'teachers', label: 'Instructors', icon: Users },
    { id: 'batches', label: 'Dance Groups', icon: Layers },
    { id: 'subjects', label: 'Choreographies', icon: Music },
    { id: 'homeworks', label: 'Practice Tracking', icon: FileText },
    { id: 'tests', label: 'Events & Shows', icon: Award },
    { id: 'attendance', label: 'Attendance Roster', icon: CheckCircle2 },
    ...
    { id: 'chat', label: 'Staff & Team Chat', icon: MessageSquare },
      ...
      <div className="p-4 border-b border-slate-800 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <span className="text-[10px] text-orange-400 font-mono tracking-wider font-extrabold uppercase">DANCE ACADEMY</span>
          </div>
        </div>
